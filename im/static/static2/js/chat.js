...
function setMsgContent(data) {
            ...
            function (val) {
                ...
                if (val.content_type === 'file') {
                    ...
                    if (fileType === ("png" || "jpg" || "jpeg")) {
                        val.content = '<img style="width: 200px; border-radius: 0;" src="/" alt="文件内容" ' + myApi + "/" + val.content + '>';
                    }
                    // 其他文件下载类型
                    // 待完善, 有兴趣的可以完善
                    // 显示文件名, 下载按钮
    ...
    if (data.content_type === 'file') {
        ...
        // 图片类型
        if (fileType === ("png" || "jpg" || "jpeg")) {
            data.content = '<img style="width: 200px; border-radius: 0;" src="/" alt="文件内容" ' + myApi + "/" + data.content + '>';
        }
    }
